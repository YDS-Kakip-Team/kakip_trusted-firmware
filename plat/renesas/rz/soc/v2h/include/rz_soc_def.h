...
#ifdef CONFIG_V2H_CM33_BOOT
#define RZV2H_SPIROM_CR8_FSP_END_OFFSET	UL(0x00280000)
#define RZV2H_SPIROM_FIP_BASE		(RZV2H_XSPI_MEMORY_MAP_BASE + RZV2H_SPIROM_CR8_FSP_END_OFFSET)
#else
