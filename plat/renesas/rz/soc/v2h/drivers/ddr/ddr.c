...
static void phyinit_d2h_1d(uint8_t base);
static void phyinit_d2h_2d(uint8_t base);
static void phyinit_mc(void);
static void phyinit_i(uint8_t base);
