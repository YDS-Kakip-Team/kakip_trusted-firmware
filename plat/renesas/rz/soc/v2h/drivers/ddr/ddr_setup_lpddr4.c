...
extern const uint32_t param_phyinit_swizzle_ch1[][2];
extern const uint32_t param_phyinit_c_ch1[][2];
extern const uint32_t param_phyinit_i_ch1[][2];
extern const uint32_t param_phyinit_f_1d_0_ch1[][2];
extern const uint32_t param_phyinit_f_2d_0_ch1[][2];
extern const uint32_t param_setup_mc_ch1[][2];
...
void setup_mc_ch1(void)
{
	size_t i;

	for (i = 0; i < param_setup_mc_size; i++) {
		ddrtop_mc_apb_wr(param_setup_mc_ch1[i][0], param_setup_mc_ch1[i][1]);
	}
}
...
void phyinit_configuration_ch1(void)
{
	size_t i;

	for (i = 0; i < param_phyinit_c_size; i++) {
		dwc_ddrphy_apb_wr(param_phyinit_c_ch1[i][0], param_phyinit_c_ch1[i][1]);
	}
}
...
void phyinit_pin_swizzling_ch1(void)
{
	size_t i;

	for (i = 0; i < param_phyinit_swizzle_size; i++) {
		dwc_ddrphy_apb_wr(param_phyinit_swizzle_ch1[i][0], param_phyinit_swizzle_ch1[i][1]);
	}
}
...
void phyinit_load_1d_image_ch1(void)
{
	size_t i;
	...
	for (i = 0; i < param_phyinit_f_1d_0_size; i++) {
		dwc_ddrphy_apb_wr(param_phyinit_f_1d_0_ch1[i][0], param_phyinit_f_1d_0_ch1[i][1]);
	}
}
...
void phyinit_load_2d_image_ch1(void)
{
	size_t i;
	...
	for (i = 0; i < param_phyinit_f_2d_0_size; i++) {
		dwc_ddrphy_apb_wr(param_phyinit_f_2d_0_ch1[i][0], param_phyinit_f_2d_0_ch1[i][1]);
	}
}
...
void phyinit_load_eng_image_ch1(void)
{
	size_t i;

	for (i = 0; i < param_phyinit_i_size; i++) {
		dwc_ddrphy_apb_wr(param_phyinit_i_ch1[i][0], param_phyinit_i_ch1[i][1]);
	}
}
